define(["exports"], (function(t) {
    ...
    class C extends class {
        ...
        constructor(t = {}) {
            t.cacheName = f(t.cacheName), super(t), this._ = !1 !== t.fallbackToNetwork, this.plugins.push(C.copyRedirectedCacheableResponsesPlugin)
        }
        async L(t, e) {
    ...
    class E {
        constructor({
            ...
            this.k = new Map, this.K = new Map, this.P = new Map, this.l = new C({
                cacheName: f(t),
                plugins: [...e, new g({
...
//# sourceMappingURL=workbox-c1760cce.js.map