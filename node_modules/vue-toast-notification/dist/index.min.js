! function(t, e) {
    ...
    o.d = (t, e) => {
        for (var s in e) o.o(e, s) && !o.o(t, s) && Object.defineProperty(t, s, {
            enumerable: !0,
            get: e[s]
        })
    ...
    return (() => {
        ...
        var t = o(976);
        const e = (0, t.createElementVNode)("div", {
                class: "v-toast__icon"
            }, null, -1),
            s = ["innerHTML"];
        ...
        function n(t) {
            var e;
            void 0 !== t.remove ? t.remove() : null === (e = t.parentNode) || void 0 === e || e.removeChild(t)
        }
        ...
        function r(e, s, o) {
            ...
            return r.classList.add("v-toast--pending"), o.appendChild(r), (0, t.render)(n, r), n.component
        }
        class a {
            constructor(t, e) {
        ...
        const u = {
                ...
                emit: function(t, e) {
                    ...
                    s && s.slice().map((function(t) {
                        t(e)
                    })), (s = c.get("*")) && s.slice().map((function(s) {
                        s(t, e)
                    }))
                }
            },
            p = (0, t.defineComponent)({
                name: "Toast",
                props: {
                    message: {
                        type: String,
                ...
                methods: {
                    ...
                    dismiss() {
                        this.timer && this.timer.stop(), clearTimeout(this.queueTimer), this.isActive = !1, setTimeout((() => {
                            ...
                            (0, t.render)(null, e), n(e)
                        }), 150)
                    },
                    showNotice() {
                        if (this.shouldQueue()) return void(this.queueTimer = setTimeout(this.showNotice, 250));
                        const t = this.$refs.root.parentElement;
                        this.correctParent.insertAdjacentElement("afterbegin", this.$refs.root), n(t), this.isActive = !0, this.duration && (this.timer = new a(this.dismiss, this.duration))
                    },
                    whenClicked() {
        ...
        const d = (0, o(831).default)(p, [
                ["render", function(o, i, n, r, a, l) {
                    return (0, t.openBlock)(), (0, t.createBlock)(t.Transition, {
                        "enter-active-class": o.transition.enter,
                        "leave-active-class": o.transition.leave
                    }, {
                        default: (0, t.withCtx)((() => [(0, t.withDirectives)((0, t.createElementVNode)("div", {
                            ref: "root",
                            role: "alert",
                            class: (0, t.normalizeClass)(["v-toast__item", ["v-toast__item--".concat(o.type), "v-toast__item--".concat(o.position)]]),
                            onMouseover: i[0] || (i[0] = t => o.toggleTimer(!0)),
                            onMouseleave: i[1] || (i[1] = t => o.toggleTimer(!1)),
                            onClick: i[2] || (i[2] = function() {
                                return o.whenClicked && o.whenClicked(...arguments)
                            })
                        }, [e, (0, t.createElementVNode)("p", {
                            class: "v-toast__text",
                            innerHTML: o.message
                        }, null, 8, s)], 34), [
                            [t.vShow, o.isActive]
                ...
                return {
                    open(e) {
                        ...
                        const o = {
                            ...
                            i = Object.assign({}, o, t, e);
                        return {
                            dismiss: r(d, i, document.body).ctx.dismiss
                        }
                    },
                    clear() {
                        u.emit("toast-clear")
            ...
            h = {
                install: function(t) {
                    let e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                        s = m(e);
                    t.config.globalProperties.$toast = s, t.provide("$toast", s)
                }
            },
            v = h
    })(), i
