...
var I = function(e) {
        ...
        return t = e, (n = [{
            ...
            value: function(e) {
                if (function(e) {
                    ...
                    if (!e.shiftKey) return !document.activeElement || V(this.lastElement()) ? (this.firstElement().focus(), void e.preventDefault()) : void 0;
                    V(this.firstElement()) && (this.lastElement().focus(), e.preventDefault())
                }
            }
        }, {
            key: "enabled",
            ...
            key: "enable",
            value: function(e) {
                e && (this.root = e, this.elements = I(this.root), this.root.addEventListener("keydown", this.onKeyDown))
            }
        }, {
            key: "disable",
            value: function() {
    ...
    K = function(e, t, n) {
        t && t.addEventListener(H[e].pc, n), t && t.addEventListener(H[e].m, n, {
            passive: !1
        })
    },
    U = function(e, t, n) {
...
var Y, q, G = "undefined" != typeof window && window.navigator && window.navigator.platform && (/iP(ad|hone|od)/.test(window.navigator.platform) || "MacIntel" === window.navigator.platform && window.navigator.maxTouchPoints > 1),
    X = [],
    Z = !1,
    J = 0,
    Q = -1,
    ...
    oe = function(e, t) {
        if (e) {
            if (!X.some((function(t) {
                ...
                X = [].concat(j(X), [n]), G ? (e.ontouchstart = function(e) {
                    1 === e.targetTouches.length && (Q = e.targetTouches[0].clientY)
                }, e.ontouchmove = function(t) {
                    1 === t.targetTouches.length && function(e, t) {
                        J = e.targetTouches[0].clientY - Q, !te(e.target) && (t && 0 === t.scrollTop && J > 0 || function(e) {
                            return !!e && e.scrollHeight - e.scrollTop <= e.clientHeight
                        }(t) && J < 0 ? ne(e) : e.stopPropagation())
                    }(t, e)
                }, Z || (document.addEventListener("touchmove", ne, F ? {
                    passive: !1
                } : void 0), Z = !0)) : function(e) {
                    if (void 0 === q) {
                        var t = !!e && !0 === e.reserveScrollBarGap,
                            n = window.innerWidth - document.documentElement.clientWidth;
                        if (t && n > 0) {
                            var o = parseInt(getComputedStyle(document.body).getPropertyValue("padding-right"), 10);
                            q = document.body.style.paddingRight, document.body.style.paddingRight = "".concat(o + n, "px")
                        }
                    }
    ...
    re = function(e) {
        e ? (X = X.filter((function(t) {
            return t.targetElement !== e
        })), G ? (e.ontouchstart = null, e.ontouchmove = null, Z && 0 === X.length && (document.removeEventListener("touchmove", ne, F ? {
            passive: !1
        } : void 0), Z = !1)) : X.length || (void 0 !== q && (document.body.style.paddingRight = q, q = void 0), void 0 !== Y && (document.body.style.overflow = Y, Y = void 0))) : console.error("enableBodyScroll unsuccessful - targetElement must be provided when calling enableBodyScroll on IOS devices.")
    },
    ie = function() {},
    ae = "enter",
    le = "entering",
    ...
    de = {
        ...
        setup: function(l, u) {
            var s = u.emit,
                ...
                I = n((function() {
                    return !1 === l.zIndex ? !!l.zIndexAuto && +l.zIndexBase + 2 * (h.value || 0) : l.zIndex
                })),
                V = n((function() {
                    return _({}, !1 !== I.value && {
                        zIndex: I.value
            ...
            function W() {
                if (l.modelValue) {
                    if (s("_before-open", X({
                            type: "_before-open"
                        })), Z("before-open", !1)) return void k("show");
                    var e = G();
                    if (e || !1 === l.attach) {
                        if (!1 !== l.attach) {
                            if (!d.value) return g.value = !0, void a((function() {
                                W()
                            }));
                            e.appendChild(d.value)
                        }
                        var t = l.api.openedModals.findIndex((function(e) {
                            return e.uid === f
                        })); - 1 !== t && l.api.openedModals.splice(t, 1), l.api.openedModals.push(F()), h.value = l.api.openedModals.length - 1, q(), l.api.openedModals.filter((function(e) {
                            return e.uid !== f
                        })).forEach((function(t, n) {
                            t.getAttachElement() === e && (t.modalStackIndex.value = n, !t.props.keepOverlay && (t.visibility.overlay = !1))
                        })), g.value = !0, w.overlay = !0, w.modal = !0
                    } else !1 !== e && console.warn("Unable to locate target ".concat(l.attach))
                }
            }

            function Y() {
                var e = l.api.openedModals.findIndex((function(e) {
                    return e.uid === f
                }));
                ...
                l.drag && ne(), l.resize && ce(), M.value = null, w.overlay = !1, w.modal = !1
            }

            function q() {
                l.modelValue && a((function() {
                    l.lockScroll ? oe(c.value, {
            ...
            function Z(e, t) {
                ...
                return s(e, o), !!n && (S.value = !0, a((function() {
            ...
            function ee(e) {
                ...
                var t, n = "resize",
                    o = "drag",
                    r = e.target.getAttribute("direction");
                if (r) t = n;
                else {
                    if (! function(e, t, n) {
                            return "" === n || j(t.querySelectorAll(n)).includes(e.target)
                        }(e, v.value, l.dragSelector)) return;
                    t = o
                }
                J(e, t, "start");
                var i, a, u, s, f = N(e),
                    d = c.value.getBoundingClientRect(),
                    p = v.value.getBoundingClientRect(),
                    m = "absolute" === window.getComputedStyle(v.value).position,
                    y = $(z.value.top),
                    h = $(z.value.left),
                    b = function() {
                        if (l.fitParent) {
                    ...
                    g = t === n && (i = document.body, a = "cursor", u = fe[r], s = i.style[a], i.style[a] = u, function() {
                        i.style[a] = s
                    }),
                    w = function(e) {
                        e.stopPropagation(), J(e, t, "move");
                        var i, a, u = N(e),
                            s = {
                                x: u.x - f.x,
                                y: u.y - f.y
                            };
                        t === n && (s = function(e, t, n, o, r) {
                            var i = function(e) {
                                    var n, o = t[e.axis];
                                    o = l.fitParent ? R(e.min, o, e.max) : o;
                                    var i = R(e.minEdge, e.getEdge(o), e.maxEdge);
                                    return o = e.getOffsetAxis(i, r), L(n = {}, e.edgeName, i), L(n, e.axis, o), n
                                },
                                a = function(e, t, r, i) {
                                    var a, u = o[t],
                                        s = n[e] - o[e],
                                        f = (a = t).charAt(0).toUpperCase() + a.slice(1);
                                    return {
                                        axis: r,
                                        edgeName: t,
                                        min: i ? s : -u,
                            ...
                            return e.split("").forEach((function(e) {
                                var t = a.apply(void 0, j(u[e]));
                                s = _(_({}, s), i(t))
                            })), s
                        }(r, s, d, p, m)), m ? (i = p.top - d.top + s.y, a = p.left - d.left + s.x) : (i = y + s.y, a = h + s.x), t === o && l.fitParent && (i = R(b.minTop, i, b.maxTop), a = R(b.minLeft, a, b.maxLeft));
                        var c = _(_(_({
                            position: "relative",
                            top: i + "px",
                            left: a + "px",
                        ...
                        z.value = _(_({}, z.value), c)
                    };
                K("move", document, w), K("up", document, (function e(o) {
                    o.stopPropagation(), t === n && g && g(), setTimeout((function() {
                        J(o, t, "end")
                    })), U("move", document, w), U("up", document, e)
                }))
            }

            function te() {
                K("down", v.value, ee), z.value.touchAction = "none"
            }
            ...
            function de() {
                w.resize = !0, a((function() {
                    K("down", p.value, ee)
                }))
            }

            function ce() {
                U("down", p.value, ee), w.resize = !1
            }
            return o((function() {
                return l.modelValue
            }), (function(e) {
                if (S.value) S.value = !1;
                    ...
                    if (Z("before-close", !0)) return void k("hide");
                    Y()
                }
            })), o((function() {
                return l.lockScroll
                ...
                l.modelValue && !e && (w.overlay = !0)
            })), o((function() {
                return l.attach
            }), W), o(P, (function(e) {
                e && (g.value = !1, c.value.style.display = "none")
            }), {
                flush: "post"
            }), o((function() {
                return l.drag
                ...
                e || (z.value = {})
            })), l.api.modals.push(F()), r((function() {
                W()
            })), i((function() {
                var e;
                Y(), l.lockScroll && c.value && re(c.value), null == d || null === (e = d.value) || void 0 === e || e.remove();
                ...
                afterModalEnter: function() {
                    E.value = ae, (l.focusRetain || l.focusTrap) && c.value.focus(), l.focusTrap && b.enable(c.value), l.drag && te(), l.resize && de(), s("_opened"), s("opened", X({
                        type: "opened"
                    })), C("show")
                },
                ...
                afterModalLeave: function() {
                    ...
                    s("_closed"), s("closed", t), C("hide"), e || (O.value = {})
                },
                onMousedown: function(e) {
                    T.value = null == e ? void 0 : e.target
                },
                onMouseupContainer: function() {
                    T.value === c.value && "resize:move" !== M.value && (s("click-outside", X({
                        type: "click-outside"
                    })), l.clickToClose && s("update:modelValue", !1))
                },
                onEsc: function() {
                    g.value && l.escToClose && s("update:modelValue", !1)
                }
            }
        }
    },
    ce = l("data-v-2836fdb5");
u("data-v-2836fdb5");
var ve = {
    key: 0,
    ref: "vfmResize",
...
var pe = ce((function(e, t, n, o, r, i) {
    return n.ssr || o.visible ? f((d(), c("div", {
        key: 0,
        ref: "root",
        style: o.bindStyle,
        class: ["vfm vfm--inset", [!1 === n.attach ? "vfm--fixed" : "vfm--absolute", {
            "vfm--prevent-none": n.preventClick
        }]],
        onKeydown: t[4] || (t[4] = v((function() {
            return o.onEsc && o.onEsc.apply(o, arguments)
        }), ["esc"]))
    }, [p(m, y(o.computedOverlayTransition, {
        ...
        default: ce((function() {
            return [!n.hideOverlay && o.visibility.overlay ? (d(), c("div", {
                key: 0,
        ...
        _: 1
    }, 16, ["onBeforeEnter", "onAfterEnter", "onBeforeLeave", "onAfterLeave"]), p(m, y(o.computedTransition, {
        ...
        default: ce((function() {
            return [f(p("div", {
                ...
                onMousedown: t[1] || (t[1] = function(e) {
            ...
            }), o.visibility.resize && o.visibility.modal ? (d(), c("div", ve, [(d(!0), c(w, null, x(n.resizeDirections, (function(e) {
                return d(), c("div", {
                    key: e,
                    direction: e,
                    class: ["vfm--resize-".concat(e), "vfm--absolute vfm--prevent-auto"]
                }, null, 10, ["direction"])
            })), 128))], 512)) : h("v-if", !0)], 38)], 46, ["aria-expanded"]), [
                [E, o.visibility.modal]
            ])]
        })),
        _: 3
...
me.render = function(e, t, n, o, r, i) {
    return d(), c("div", ye, [(d(!0), c(w, null, x(e.api.dynamicModals, (function(e, t) {
        return d(), c(S(e.component), y({
            key: e.id
        }, e.bind, {
            modelValue: e.value,
            ...
            on_beforeOpen: function(t) {
                return i.beforeOpen(t, e)
            },
            on_opened: e.opened
        }), z({
            _: 2
        }, [x(e.slots, (function(e, t) {
            return {
                name: t,
                fn: M((function() {
                    return [h(" eslint-disable vue/no-v-html "), i.isString(e) ? (d(), c("div", {
                        key: 0,
                        innerHTML: e
                    }, null, 8, ["innerHTML"])) : (d(), c(S(e.component), y({
                        key: 1
                    }, e.bind, O(e.on || {})), null, 16))]
                }))
            }
...
var be = 0,
    ge = function() {
        var e, t, n = (t = null, {
            show: function(e) {
                for (var n = this, o = arguments.length, r = new Array(o > 1 ? o - 1 : 0), i = 1; i < o; i++) r[i - 1] = arguments[i];
                switch (C(e)) {
                    case "string":
                        return this.toggle.apply(this, [e, !0].concat(r));
                    case "object":
                        return Promise.allSettled([new Promise((function(o, i) {
                            var a = {
                                value: !0,
                            ...
                            n.dynamicModals.push(T(Object.assign(a, e)))
                        }))])
                }
            },
            hide: function() {
            ...
            hideAll: function() {
                return this.hide.apply(this, j(this.openedModals.map((function(e) {
                    return e.props.name
                }))))
            },
            toggle: function(e) {
                for (var t = arguments.length, n = new Array(t > 1 ? t - 1 : 0), o = 1; o < t; o++) n[o - 1] = arguments[o];
                var r = Array.isArray(e) ? this.get.apply(this, j(e)) : this.get(e);
        ...
        return L(e = {}, "$vfm", n), L(e, "VueFinalModal", function(e) {
            var t = he(de, e);
            return e._setDefaultModal(t), t
        }(n)), L(e, "ModalsContainer", function(e) {
            return he(me, e)
        }(n)), e
    },
    we = ge(),
    ...
    Oe = function(e) {
        ...
        var a = t.key || "$vfm",
            ...
            u = t.dynamicContainerName || "ModalsContainer";
...
export default ze;
export {
    xe as $vfm, Se as ModalsContainer, Ee as VueFinalModal, ge as defineVfm, ze as vfmPlugin
};
