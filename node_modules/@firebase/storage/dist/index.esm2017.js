...
function getBytesInternal(ref, maxDownloadSizeBytes) {
    ...
    return ref.storage
        ...
        .then(bytes => maxDownloadSizeBytes !== undefined ? // GCS may not honor the Range header for small files
...
function getBlobInternal(ref, maxDownloadSizeBytes) {
    ...
    return ref.storage
        ...
        .then(blob => maxDownloadSizeBytes !== undefined ? // GCS may not honor the Range header for small files
