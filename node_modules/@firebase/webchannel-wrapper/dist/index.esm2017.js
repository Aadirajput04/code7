...
Ua.prototype.add = function(a, b, c, d, e) {
    ...
    a = this.g[f];
    a || (a = this.g[f] = [], this.h++);
    var h = Va(a, b, d, e); - 1 < h ? (b = a[h], c || (b.ea = !1)) : (b = new Oa(b, this.src, f, !!d, e), b.ea = c, a.push(b));
    return b
};
...
function C(a, b) {
    ...
    e = kb(h, d, !1, b) && e;
    if (c)
        for (f = 0; f < c.length; f++) h = b.g = c[f], e = kb(h, d, !1, b) && e;
}
            ...
            if (!(3 > r) && (3 != r || ya || this.g && (this.h.h || this.g.fa() || hc(this.g)))) {
                ...
                if (this.i) {
                    if (this.Z && !this.J) {
                        ...
                        if (c = m) E(this.j, this.m, c, "Initial handshake response via X-HTTP-Initial-Response"),
                        this.J = !0,
                        kc(this, c);
                        else {
                            this.i = !1;
...
function lc(a, b, c) {
    ...
    a.i = a.i && d;
    d ? 0 < c.length && !a.$ && (a.$ = !0, b = a.l, b.g == a && b.$ && !b.K && (b.j.info("Great, no buffering proxy detected. Bytes received: " + c.length), oc(b), b.K = !0, I(11))) : (E(a.j, a.m, c,
        "[Invalid Chunked Response]"), P(a), Q(a));
}
k.hb = function() {
    if (this.g) {
        var a = O(this.g),
                ...
                if (2 == c.G)
                    if ("c" == m[0]) {
                        ...
                        if (Z) {
                            ...
                            if (d.D) {
                                const tb =
                                    Z.g ? Z.g.getResponseHeader("X-HTTP-Session-Id") : null;
...
function Dc(a, b) {
    ...
    else if (ba(a) || "string" === typeof a) Array.prototype.forEach.call(a, b, void 0);
    else
        for (var c = Cc(a), d = Bc(a), e = d.length, f = 0; f < e; f++) b.call(void 0, d[f], c && c[f], a);
}
...
k.W = function(a) {
    U(this);
    let b = [];
    if ("string" === typeof a) Uc(this, a) && (b = b.concat(this.g.get(V(this, a))));
    else {
...
k.Wa = function(a) {
    if (this.g && (this.l = a, this.h || (this.status = this.l.status, this.statusText = this.l.statusText, this.h = a.headers, this.readyState = 2, hd(this)), this.g && (this.readyState = 3, hd(this), this.g)))
        if ("arraybuffer" === this.responseType) a.arrayBuffer().then(this.Ua.bind(this), this.ga.bind(this));
...
function Dd(a, b, c) {
    ...
    a: {
        ...
        let f = -1;
        for (;;) {
            const h = ["count=" + c]; - 1 == f ? 0 < c ? (f = e[0].h, h.push("ofs=" + f)) : f = 0 : h.push("ofs=" + f);
            let n = !0;
            for (let u = 0; u < c; u++) {
                let m = e[u].h;
                const r = e[u].g;
...
function mc(a, b) {
    ...
    if (a.g == b) {
        ...
        a.g = null;
        var d = 2;
    } else if (qc(a.h, b)) c = b.D, xc(a.h, b), d = 1;
    else return;
    if (0 != a.G)
        if (a.pa = b.Y, b.i)
            if (1 == d) {
...
function Id(a) {
    ...
    if (b) {
        ...
        if (this.i = a) a = this.i,
        b = null !== b && a in b ? b[a] : void 0;this.data = b;
    }
    else this.data = a;
}
t(Id, Vb);
